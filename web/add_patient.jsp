...
<%
    ...
    try {
        ...
        ps = conn.prepareStatement("SELECT id, hospital_name FROM doctors WHERE LOWER(TRIM(fullname)) = LOWER(TRIM(?)) LIMIT 1");
...
<div class="dashboard-content">
    <div class="card-box">
        ...
        <div class="search-and-button-row">
            ...
            <a href="appointment.jsp?doctorId=<%= doctorId %>&doctorName=<%= URLEncoder.encode(fullname, "UTF-8") %>&hospitalName=<%= URLEncoder.encode(hospitalName, "UTF-8") %>" 
               class="add-patient-btn-inline" title="Add New Patient">
               +
            </a>
        </div>
